    ...
    return(
        ...
        <div className="OnePullRequest-container">
            <div className="OnePullRequest-container__left-part">
                    <p className="OnePullRequest-container__left-part__title">Merge branch {pull?.head.ref} into {pull?.base.ref} <MergeIcon/> </p>
                    <p className="OnePullRequest-container__left-part__date"> Created At:      {dayjs(pull.created_at).format('YYYY-MM-DD')} </p>
            </div>
             <div className="OnePullRequest-container__right-part">
                    <div className='OnePullRequest-container__right-part__icons'>
                            <img  className='OnePullRequest-container__right-part__icons__avatar' src={pull?.user.avatar_url} />
                            <div className='OnePullRequest-container__right-part__icons__isverified'>
                              <p className= { `OnePullRequest-container__right-part__icons__isverified__state${!pull?.locked? "__open":"__closed"}`}>{pull?.state} </p>
                              <img  className='OnePullRequest-container__right-part__icons__isverified__icon' src={ !pull.locked? verified:rejected} />
                            </div>
